  ...
  return (
    <div className="text-center pt-5 text-black text-[30px] font-bold font-['Inter'] leading-10">
      ...
      <div className="text-[16px] mt-6">
        ...
        <div className="text-[#000000] mt-8 mb-5 text-base font-bold font-['Inter'] leading-tight">
          구글폼
          <div className="text-[#FF7710] text-xs font-bold font-['Inter'] leading-tight">~ 3.13 까지 필수 작성</div>
          <a href="https://forms.gle/FjJ3r5C8C6hnJeMs7" target="_blank" rel="noopener noreferrer" style={{ textDecorationLine: "underline" }}>
            https://forms.gle/FjJ3r5C8C6hnJeMs7
          </a>
        </div>
        <div className="text-[#000000] text-base font-bold font-['Inter'] leading-tight">
          디스코드
          <div className="text-[#FF7710] text-xs font-bold font-['Inter'] leading-tight">"[아기사자] 이름"으로 서버 별명 설정</div>
          <a href="https://discord.gg/BmzWv39v" target="_blank" rel="noopener noreferrer" style={{ textDecorationLine: "underline" }}>
            https://discord.gg/BmzWv39v
          </a>
        </div>
      </div>
    </div>
        ...
        <div className="page-space">
          ...
          <div className="center">
            <div className="flex flex-col items-center">
              <div className="w-72 h-16 mt-8 text-center text-white text-[50px] font-bold font-['Inter'] leading-10">합격자 조회</div>
